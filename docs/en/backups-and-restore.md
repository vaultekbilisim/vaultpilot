...
The download identifies VaultPilot Backup Tool version `1.0.1`. The adjacent `VaultPilotLogCollector.exe` has its own independent `1.0.1` version. These tool versions do not inherit the VaultPilot server version.
