...
2. Release tag değerinin `v1.8.20` olduğunu doğrula.
3. `passman-update.json` indir.
4. Manifestin server version olarak `1.8.20` gösterdiğini doğrula.
5. MSI filename değerinin `PassMan-1.8.20-x64.msi` olduğunu doğrula.
