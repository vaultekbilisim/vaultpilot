...
İndirme alanı VaultPilot Backup Tool sürümünü `1.0.1` olarak gösterir. Yanındaki `VaultPilotLogCollector.exe` dosyasının da sunucudan bağımsız kendi `1.0.1` sürümü vardır. Bu araçların sürümü VaultPilot sunucu sürümünü devralmaz.
