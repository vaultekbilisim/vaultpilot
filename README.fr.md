...
| Zone | D&eacute;tail |
| --- | --- |
| Release publique actuelle | VaultPilot Enterprise Vault Console 2.0.0, GitHub Release [v2.0.0](https://github.com/vaultekbilisim/vaultpilot/releases/tag/v2.0.0). |
